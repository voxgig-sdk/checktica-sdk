...
The Python SDK for the Checktica API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Detect()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/checktica-sdk/releases)) or
...
| `text` | `str` | The text to analyze for AI detection. |
...
```
py/
├── checktica_sdk.py         -- Main SDK module
