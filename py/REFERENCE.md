# Checktica Python SDK Reference

Complete API reference for the Checktica Python SDK.
...
#### `CheckticaSDK.test(testopts=None, sdkopts=None)`
...
Create a new `DetectEntity` instance. Pass `None` for no initial data.
...
| `text` | `str` | Yes | The text to analyze for AI detection. |
...
Create a new `DetectEntity` instance with the same options.
