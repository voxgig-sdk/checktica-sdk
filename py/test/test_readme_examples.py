# Checktica SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CheckticaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CheckticaSDK(...) and CheckticaSDK.test(...) become
#      CheckticaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "checktica_sdk"
_SDK_CLASS = "CheckticaSDK"
