...
from checktica_sdk.checktica_types import (
    Detect,
    DetectCreateData,
)
...
class DetectEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DetectEntity(self._client, opts)
    ...
    def create(self, reqdata: DetectCreateData, ctrl=None) -> Detect:
        utility = self._utility
