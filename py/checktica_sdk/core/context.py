...
from checktica_sdk.core.helpers import get_ctx_prop, to_map
...
class CheckticaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, CheckticaSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CheckticaResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CheckticaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CheckticaError(code, msg, self)
