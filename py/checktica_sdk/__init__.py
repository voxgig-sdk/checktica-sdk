...
from checktica_sdk.utility import register

# Load features
from checktica_sdk.feature.base_feature import CheckticaBaseFeature
from checktica_sdk.features import _has_feature, _make_feature
...
class CheckticaSDK:
    ...
    def get_utility(self):
        return CheckticaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CheckticaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Detect(self, data=None) -> "DetectEntity":
        ...
        from checktica_sdk.entity.detect_entity import DetectEntity
