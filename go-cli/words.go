...
func registerSDKWords(r *eng.Registry, client *sdk.CheckticaSDK) {
...
func runOp(client *sdk.CheckticaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
