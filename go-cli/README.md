...
AQL-driven CLI and REPL for the Checktica SDK. Positional arguments are
...
./checktica-cli list detect
./checktica-cli load 1 detect
./checktica-cli load '{id:1}' detect
