...
func (sdk *CheckticaSDK) OptionsMap() map[string]any {
...
func (sdk *CheckticaSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CheckticaSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CheckticaSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CheckticaSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CheckticaSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CheckticaSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CheckticaSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CheckticaSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CheckticaSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CheckticaSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
