...
type DetectEntity struct {
	name    string
	client  *core.CheckticaSDK
...
func NewDetectEntity(client *core.CheckticaSDK, entopts map[string]any) *DetectEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DetectEntity) GetName() string { return e.name }
...
func (e *DetectEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DetectEntity) Deleted() bool {
	return e.deleted
}


func (e *DetectEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDetectEntity(e.client, opts)
}

func (e *DetectEntity) Data(args ...any) any {
...
func (e *DetectEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DetectEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DetectEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DetectEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *DetectEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DetectEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DetectEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
