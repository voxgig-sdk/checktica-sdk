...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = CheckticaOmni.make_runner(TEST_JSON_FILE, CheckticaSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : CheckticaOmni.errify(err)
    end
