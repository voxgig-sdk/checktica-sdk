...
// Checktica SDK clienttrack feature
...
class CheckticaClienttrackFeature extends CheckticaBaseFeature
{
    ...
    public function PostConstruct(CheckticaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Checktica-SDK';
