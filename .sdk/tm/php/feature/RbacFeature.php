...
class CheckticaRbacFeature extends CheckticaBaseFeature
{
    ...
    private function _required(CheckticaContext $ctx): ?string
    {
    ...
    private function _reject(CheckticaContext $ctx, string $required): void
    {
    ...
    private function _track(CheckticaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
