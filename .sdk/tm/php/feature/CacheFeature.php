...
class CheckticaCacheFeature extends CheckticaBaseFeature
{
    ...
    private function _through(CheckticaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
