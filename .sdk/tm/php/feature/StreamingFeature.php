...
// Checktica SDK streaming feature
...
class CheckticaStreamingFeature extends CheckticaBaseFeature
{
    ...
    private function _iterate(CheckticaResult $result): \Generator
    {
    ...
    private function _streamable(CheckticaContext $ctx): bool
    {
