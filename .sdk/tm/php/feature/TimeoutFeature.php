...
class CheckticaTimeoutFeature extends CheckticaBaseFeature
{
    ...
    private function _with_timeout(CheckticaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CheckticaContext $_ctx, float $ms): void
    {
        $client = $this->client;
