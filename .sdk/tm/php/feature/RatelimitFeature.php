...
// Checktica SDK ratelimit feature
...
class CheckticaRatelimitFeature extends CheckticaBaseFeature
{
    ...
    private function _acquire(CheckticaContext $ctx): void
    {
    ...
    private function _track(CheckticaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
