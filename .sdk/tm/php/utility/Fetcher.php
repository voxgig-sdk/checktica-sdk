...
// Checktica SDK utility: fetcher

class CheckticaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CheckticaSDK/1.0)';
    ...
    public static function call(CheckticaContext $ctx, string $fullurl, array $fetchdef): array
    {
