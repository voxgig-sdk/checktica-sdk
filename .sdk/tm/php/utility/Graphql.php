...
class CheckticaGraphql
{
    ...
    // equivalent.
    public static function body(CheckticaContext $ctx): mixed
    {
    ...
    public static function errors(CheckticaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
