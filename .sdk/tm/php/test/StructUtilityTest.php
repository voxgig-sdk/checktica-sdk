...
// Checktica SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CheckticaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CheckticaOmni::structfix($now, Struct::undef()))
                        !== json_encode(CheckticaOmni::structfix($val, Struct::undef()))) {
