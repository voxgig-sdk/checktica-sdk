...
|---|---|---|
| `ts/` | @voxgig-sdk/checktica-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/checktica-sdk \
      --repository voxgig-sdk/checktica-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/checktica-sdk` shows it, and
`npm trust revoke @voxgig-sdk/checktica-sdk --id=<id>` removes it.
