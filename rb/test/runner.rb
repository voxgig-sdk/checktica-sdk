...
module CheckticaTestRunner
  ...
  def self.env_override(m)
    live = getenv("CHECKTICA_TEST_LIVE")
    override = getenv("CHECKTICA_TEST_OVERRIDE")
    ...
    explain = getenv("CHECKTICA_TEST_EXPLAIN")
    m["CHECKTICA_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CheckticaTestRunner
Helpers = CheckticaHelpers
Vs = VoxgigStruct
