...
function envOverride(m) {
    if ('TRUE' === process.env.CHECKTICA_TEST_LIVE ||
        'TRUE' === process.env.CHECKTICA_TEST_OVERRIDE) {
    ...
    m.CHECKTICA_TEST_EXPLAIN = process.env.CHECKTICA_TEST_EXPLAIN || m.CHECKTICA_TEST_EXPLAIN;
    return m;
}
