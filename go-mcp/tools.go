...
type Args struct {
	Entity string         `json:"entity" jsonschema:"detect"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CheckticaSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "checktica_list",
		Description: "List records from Checktica. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "checktica_load",
		Description: "Load a single record from Checktica. " +
...
func runOp(client *sdk.CheckticaSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CheckticaSDK, name string) (sdk.CheckticaEntity, error) {
	switch strings.ToLower(name) {
	case "detect":
		return client.Detect(nil), nil
