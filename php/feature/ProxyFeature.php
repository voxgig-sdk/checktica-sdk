...
class CheckticaProxyFeature extends CheckticaBaseFeature
{
    ...
    public function init(CheckticaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CheckticaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
