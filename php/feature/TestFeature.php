...
// Checktica SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CheckticaTestFeature extends CheckticaBaseFeature
{
    ...
    public function init(CheckticaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CheckticaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CheckticaParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CheckticaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CheckticaContext $ctx, $op, $args): array
    {
