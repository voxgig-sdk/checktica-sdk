...
The PHP SDK for the Checktica API — an entity-oriented client using PHP conventions.
...
```php
require_once 'checktica_sdk.php';
$client = new CheckticaSDK($options);
```
...
```
php/
├── checktica_sdk.php          -- Main SDK class
...
The main class (`checktica_sdk.php`) exports the SDK class
