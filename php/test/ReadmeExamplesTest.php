...
// Checktica SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CheckticaSDK::test)
...
{
    private const SDK_CLASS = 'CheckticaSDK';
    ...
    private const SDK_BASE = 'checktica_sdk';
