...
class CheckticaTestRunner
{
    ...
    {
        $live = self::getenv('CHECKTICA_TEST_LIVE');
        $override = self::getenv('CHECKTICA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CHECKTICA_TEST_EXPLAIN');
...
class_alias('CheckticaTestRunner', 'Runner');
class_alias('CheckticaHelpers', 'Helpers');
