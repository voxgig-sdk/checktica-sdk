...
// Checktica SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CheckticaTransformResponse
{
    public static function call(CheckticaContext $ctx): mixed
    {
        ...
        $transform = CheckticaHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
